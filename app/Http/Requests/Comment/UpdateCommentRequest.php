...
class UpdateCommentRequest extends BaseRequest
{
    ...
    /**
     * Summary of rules
     * @return array{attachment: string[], attachment.*: string[], commentable_id: string, commentable_type: string, content: string}
     */
    ...
    /**
     * Summary of messages
     * @return array{attachment.*.file: string, attachment.*.max: string, attachment.*.mimetypes: string, attachment.array: string, commentable_id.exists: string, commentable_id.integer: string, commentable_id.required: string, commentable_type.in: string, commentable_type.required: string, content.max: string, content.string: string}
     */
    public function messages(): array
    {
        return [
            ...
            'commentable_type.required' => 'The commentable type must be required.',
     ...
     * @return string
     */
    protected function resolveCommentableTable(): string
    {
